...
describe("Kuroshiro Node Initialization Test", () => {
    ...
    it("Invalid Initialization Parameter(1)", (done) => {
        try {
            kuroshiro.init();
    ...
    it("Invalid Initialization Parameter(2)", (done) => {
        try {
            kuroshiro.init("param");
            done("SHOULD NOT BE HERE");
        }
        catch (err) {
            done();
    ...
    it("Invalid Initialization Parameter(3)", (done) => {
        try {
            kuroshiro.init({});
            done("SHOULD NOT BE HERE");
        }
    ...
    it("Repeated Initialization", (done) => {
        try {
...
describe("Kuroshiro Node Funtional Test", () => {
    ...
    it("Convert - Wrong Parameter - Invalid Target Syllabary", (done) => {
        const ori = EXAMPLE_TEXT;
        try {
            const result = kuroshiro.convert(ori, { to: "xxxx" });
            done("SHOULD NOT BE HERE");
        }
        catch (err) {
            done();
    ...
    it("Convert - Wrong Parameter - Invalid Conversion Mode", (done) => {
        const ori = EXAMPLE_TEXT;
        try {
            const result = kuroshiro.convert(ori, { to: "hiragana", mode: "xxxx" });
            done("SHOULD NOT BE HERE");
        }
        catch (err) {
            done();
    ...
    it("Convert - Wrong Parameter - Invalid Romanization System", (done) => {
        const ori = EXAMPLE_TEXT;
        try {
            const result = kuroshiro.convert(ori, { to: "hiragana", romajiSystem: "xxxx" });
            done("SHOULD NOT BE HERE");
        }
        catch (err) {
            done();
    ...
    it("Kanji to Hiragana with okurigana(7)", () => {
        const ori = "渡り鳥";
        const result = kuroshiro.convert(ori, { mode: "okurigana", to: "hiragana" });
